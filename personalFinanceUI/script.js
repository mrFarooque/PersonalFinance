...
function loadUserData(token) {
    ...
    async function findUsername() {
        let response = await fetch("http://localhost:8888/user/name", {
            method: 'GET',
            headers: {
    ...
    findUsername(token) // calling this function to get username 
    // GET: list all expense of current month
    async function listExpenseCurrentMonth() {
        let response = await fetch("http://localhost:8888/finance/list/current", {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-type': 'application/json',
    ...
    async function showAllData(type, month) {
        let response = await fetch("http://localhost:8888/finance/list/"+type+"/"+month, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-type': 'application/json',
    ...
    async function fillData(month) {
        ...
        categories.forEach(category => {
            async function getData() {
                let response = await fetch("http://localhost:8888/finance/total/EXPENSE/"+category+"/"+month, {
                    method: 'GET',
                    headers: {
                        'Accept': 'application/json',
                        'Content-type': 'application/json',
        ...
        let balance = await fetch("http://localhost:8888/finance/balance/"+month, {
            method: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-type': 'application/json',
    ...
    async function deletExpenseById(id) {  
        fetch("http://localhost:8888/finance/"+id, {
            method: 'DELETE',
            headers: {
                'Accept': 'application/json',
                'Content-type': 'application/json',
